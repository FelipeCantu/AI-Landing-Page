  ...
  return (
    <section className='py-20 md:py-24'>
      <div className='container'>
        ...
        <p className='text-white/70 text-lg md:text-xl text-center mt-5 tracking-tight max-w-sm mx-auto'>Our revolutionary AI SEO tools have transformed our cilents' strategies.</p>
